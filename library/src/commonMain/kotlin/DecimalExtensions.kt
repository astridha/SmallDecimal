...
public fun UByte.toDecimal():Decimal = Decimal(this.toByte())
public fun Short.toDecimal():Decimal = Decimal(this)
public fun UShort.toDecimal():Decimal = Decimal(this.toShort())
public fun Int.toDecimal():Decimal = Decimal(this)
public fun UInt.toDecimal():Decimal = Decimal(this.toInt())
public fun Long.toDecimal():Decimal = Decimal(this)
public fun ULong.toDecimal():Decimal = Decimal(this.toLong())
